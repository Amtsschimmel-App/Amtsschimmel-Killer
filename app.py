...
# --- 4. TOP-BAR: RECHTLICHES (ABSTÄNDE FIXIERT) ---
...
with col_right:
    ...
    if uploaded_file:
        ...
        with tab_ans: 
            st.text_area("Ihr Antwortentwurf:", res.get('antwort'), height=280, key="ans_box")
        with tab_wid: 
            st.text_area("Ihr Widerspruchsentwurf:", res.get('widerspruch'), height=280, key="wid_box")
        with tab_dl:
