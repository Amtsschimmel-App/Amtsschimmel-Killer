...
def get_ai_analysis(text):
    try:
        ...
        # Fix für 'list' object error (choices.message.content)
        content = response.choices[0].message.content
        return json.loads(content)
    except Exception as e:
        return {"analyse": f"Fehler: {str(e)}", "antwort": "Fehler bei Generierung", "widerspruch": "Fehler bei Generierung", "frist": "Nicht erkannt"}
